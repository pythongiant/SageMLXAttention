...
leveraging optimized Metal kernels for maximum performance.

Key features:
- K smoothing via mean subtraction (NVIDIA SageAttention approach)
- LSE correction for ring attention compatibility
- Optimized Metal kernel implementation via mlx_kernels
...
from .mlx_kernels import mlx_sage_attention, mlx_quantized_matmul_fused, SageAttentionConfig
